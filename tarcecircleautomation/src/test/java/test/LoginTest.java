...
@Test
public void TC_LGN_0087_RegisteredUser_Login_ShouldPass() throws Exception {

    openLoginPage();

    LoginPage login = new LoginPage(driver, wait);

    login.enterEmail("system@tracecircle.com");
    login.enterPassword("StrongPassword@123");
    login.clickLogin();

    System.out.println("✅ Login page opened and credentials entered");
}
// @Test
...
public void TC_LGN_021_EmailWithLeadingTrailingSpaces_ShouldBeHandled() throws Exception {
    ...
    try {
        ...
        System.out.println("TC_LGN_021 PASSED");

    } catch (Exception | AssertionError e) {

        ScreenshotUtil.captureScreenshot(driver, "TC_LGN_021_EmailWithLeadingTrailingSpaces");
